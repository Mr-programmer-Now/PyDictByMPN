...
e1_value=StringVar()
e1 = Entry(window,textvariable=e1_value,bg="white",fg="black",justify = CENTER,font = ('courier', 5, 'bold'))
e1.place(relx=.185,rely=0.70,relwidth=.63,relheight=.082)

#seach button to execute command

b1 = Button(window,text="Search",command= lambda : search(e1_value.get()),relief=FLAT,bg="green",fg="white",font = ('courier', 4, 'bold') )
b1.place(relx=.40,rely=.85,relwidth=.2,relheight=.052)

#ouput the definition of the word
t1 = Text(window,fg="white",relief=FLAT,bg="#444444",font = ('courier', 3, 'bold'))
t1.place(relx=.165,rely=.05,relwidth=.76,relheight=.35)
